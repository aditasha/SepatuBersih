...
@Singleton
class FirebaseOrderDriverAdapter(options: FirebaseRecyclerOptions<SbOrderItem>) :
    FirebaseRecyclerAdapter<SbOrderItem, FirebaseOrderDriverAdapter.OrderViewHolder>(options) {
    private lateinit var orderOnClickCallback: OrderDriverOnClickCallback
    ...
    fun setOnClickCallback(orderOnClickCallback: OrderDriverOnClickCallback) {
